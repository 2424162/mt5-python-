...
import itchat
import os
#path ="C:\\Users\\Lenovo\AppData\Roaming\MetaQuotes\Terminal\D0E8209F77C8CF37AD8BF550E51FF075\MQL5\Files\邮箱微信\\"
path =".\Files\邮箱微信\\"
if not os.path.exists(path):
      os.makedirs(path)
def youxiang(rec,str,filename):
    receivers = rec.split(',')
...
def weixin(friends,str,filename):
